...
def get_output(frame):
        ...
        global opt, video_path, fps, webcam_width, webcam_height, _output, output, frame_array, current_hand, res
...
def process_frame_route():
    ...
    processed_frame = get_output(frame)
    ...
    print("Returning processed frames!")
